...
/data/markellocj/raw_read_data/${COHORT_NAME}_cohort_precision_fda_reads/${SAMPLE_NAME}/${SAMPLE_NAME}.novaseq.pcr-free.35x.R1.fastq.gz \
/data/markellocj/raw_read_data/${COHORT_NAME}_cohort_precision_fda_reads/${SAMPLE_NAME}/${SAMPLE_NAME}.novaseq.pcr-free.35x.R2.fastq.gz \
