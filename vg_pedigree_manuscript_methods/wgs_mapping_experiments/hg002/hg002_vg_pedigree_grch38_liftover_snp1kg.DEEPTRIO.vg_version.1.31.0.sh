...
WORKDIR="/data/Udpwork/usr/markellocj/non_segdup_vg_pedigree_runs/hg002_cohort"
OUTSTORE="${WORKDIR}/HG002_pedigree_giraffe_deeptrio_grch38_liftover_non_segdup_snp1kg_wgs_vg_1.31.0_outstore"
JOBSTORE="${WORKDIR}/HG002_pedigree_giraffe_deeptrio_grch38_liftover_non_segdup_snp1kg_wgs_vg_1.31.0_jobstore"
LOGFILE="${WORKDIR}/HG002_pedigree_giraffe_deeptrio_grch38_liftover_non_segdup_snp1kg_wgs_vg_1.31.0.log"
...
HG004 \
HG003 \
--fastq_proband /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG002/HG002.novaseq.pcr-free.35x.R1.fastq.gz /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG002/HG002.novaseq.pcr-free.35x.R2.fastq.gz \
--fastq_maternal /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG004/HG004.novaseq.pcr-free.35x.R1.fastq.gz /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG004/HG004.novaseq.pcr-free.35x.R2.fastq.gz \
--fastq_paternal /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG003/HG003.novaseq.pcr-free.35x.R1.fastq.gz /data/markellocj/raw_read_data/HG002_cohort_precision_fda_reads/HG003/HG003.novaseq.pcr-free.35x.R2.fastq.gz \
...
--ped_file /data/markellocj/test_vg_wdl_run/tiny_workflow_inputs/HG002.ped \
