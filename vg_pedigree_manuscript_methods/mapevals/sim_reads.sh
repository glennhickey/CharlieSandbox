...
## SIMULATE REGION SPECIFIC READS
#REGION="alllowmapandsegdupregions_hg002_v4.2.1_regions"
#BED_FILE="HG002_GRCh38_v4.2.1.alllowmapandsegdupregions.bed"
#REGION="cmrg_hg002_v4.2.1_regions"
#BED_FILE="HG002_GRCh38_CMRG_smallvar_v1.00.bed"
REGION="high_conf_NO1000GP_hg002_v4.2.1_regions"
BED_FILE="HG002_GRCh38_CHROM1-22_v4.2.1.highconf.NO_SNP1KG.bed"
mkdir -p ${REGION}
