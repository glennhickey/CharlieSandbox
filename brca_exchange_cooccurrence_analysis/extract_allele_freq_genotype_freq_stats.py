...
def main(args):
    ...
    for record in vcf_reader:
        ...
        all_maf_dist.extend([float(record.INFO['AF'][0])]*minor_allele_count)
        if variant_record in vus_list:
            vus_maf_dist.extend([record.INFO['AF'][0]]*minor_allele_count)
            ...
            non_vus_maf_dist.extend([record.INFO['AF'][0]]*minor_allele_count)
    ...
    fig1.savefig("hom_vus_HWE_AF_distributions.{}.png".format(options.outReport))
    ...
    fig2.savefig("non_hom_vus_HWE_AF_distributions.{}.png".format(options.outReport))
    ...
    fig4.savefig("hom_vus_maf_dist.{}.png".format(options.outReport))
    ...
    matplotlib.pyplot.xscale('linear')
    fig5.savefig("non_hom_vus_maf_dist.{}.png".format(options.outReport))
    ...
    matplotlib.pyplot.xscale('linear')
    fig6.savefig("all_maf_dist.{}.png".format(options.outReport))
